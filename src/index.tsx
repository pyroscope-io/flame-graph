...
class FlameGraph extends React.Component {
  ...
  renderCanvas = () => {
    ...
    this.canvas.height = this.props.height ? this.props.height - 30 : PX_PER_LEVEL * (levels.length - this.topLevel);
    ...
    return (
      ...
      >
        <div className="flamegraph-header">
          ...
          {ExportData && <ExportData flameCanvas={this.canvasRef} label={this.props.label || ""} />}
        </div>
